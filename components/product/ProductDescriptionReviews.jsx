            ...
            <div className="flex ">
                <button
                    className={`md:text-md text-sm border-[0.5px] rounded-[8px_8px_0px_0px] flex justify-center items-center border-gray w-[154px] h-[45px]  relative transition-all duration-150 ease-in font-bold  ${
                        activeTab === "All" ? "text-primary border_bottom" : "text-lightblack "
                    }`}
                ...
                <button
                    className={`md:text-md border-[0.5px] ml-[12px] rounded-[8px_8px_0px_0px] flex justify-center items-center border-gray w-[154px] h-[45px] text-sm  flex items-center  relative transition-all duration-150 ease-in font-bold  ${
                        activeTab === "Milks" ? "text-primary" : "text-lightblack "
                    }`}
                    onClick={() => setActiveTab("Milks")}
                >
                    <span>Reviews</span>
                    <span className=" ml-[10px] p-[5px] rounded-[50%]  bg-perfectwhite font-normal ff_lato text-[10px]">12</span>
                </button>
            </div>
